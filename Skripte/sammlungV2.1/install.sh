...
sudo echo 'export PATH=$PATH:/usr/share/dotnet' >> ~/.profile
sudo echo 'export DOTNET_ROOT=/usr/share/dotnet' >> ~/.profile
sudo cat ~/.profile

sudo nano ~/.bashrc
sudo sh /home/github/sammlungV2.1/continueInstall.sh
sudo reboot -h now
